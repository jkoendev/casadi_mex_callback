...
clang++ -c -DMX_COMPAT_32 -DMATLAB_MEX_FILE  -I"../../Software/casadi-osx-matlabR2014b-v3.3.0/include/"   -fno-common -arch x86_64 -fexceptions -fobjc-arc -O2 -DNDEBUG /Users/jonas/Documents/repos/casadi_mex_callback/casadi_mex.cc -o casadi_mex.o -std=c++11
